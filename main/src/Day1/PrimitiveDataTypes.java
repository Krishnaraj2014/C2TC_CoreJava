...
public class PrimitiveDataTypes {
	...
	public static void main(String[] args) {
		...
		//float - 4bytes
		float f=3234.141243278345f; //float print decimal values upto 7 decimal
		double d=3456.14124512345678902345678914f; //double print decimal values upto 16 decimal
